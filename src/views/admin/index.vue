<template>
    <div class="common-layout">
        <el-container>
            <el-aside width="20%" style="margin-right: 5px;">
                <el-row class="tac">
                    <el-col :span="24">
                        <h3 class="mb-2">CodeSky 管理面板</h3>
                        <el-menu default-active="/admin/setting" class="el-menu-vertical-demo" @open="handleOpen" router
                            @close="handleClose">
