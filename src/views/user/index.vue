        ...
        <el-col :span="24">
            <el-card shadow="always" style="height: 800px;">
                <div style="text-align: center;">
                    关注: 0 <el-divider direction="vertical" /> 粉丝: 0 <br><br>
                    <!-- 经验进度条 -->
                    <el-progress :stroke-width="20" :percentage="user.experience / (1000 * user.level) * 100"
                        status="exception">
                        <span style="font-size: 5px;color: grey">{{ user.experience }} / {{ 1000 * user.level }}</span>
                    </el-progress>
                    <br>
                    <!-- 修改个人简介 -->
                    <el-button type="success" plain style="width: 70%;" @click="dialogVisible = true">修改个人简介</el-button>
                    <el-dialog v-model="dialogVisible" title="修改个人信息" width="40%">
                        ...
                        <el-form :model="form" label-width="120px">
                            ...
                            <el-form-item label="头像">
                                ...
                                <el-tooltip class="box-item" effect="dark" content="为节省服务器资源,请将图片上在线图床后使用url方式引用"
                                    placement="right">
                ...
                <div>
                    ...
                    <div class="info"> <el-icon>
                        ...
                        <el-tag class="ml-2" v-for="tags in user.tag" type="info" style="margin-left: 5px;">{{ tags }}
                        </el-tag>
                    </div>
                </div>
            </el-card>
